...
class MultiHeadAttentionWrapper(nn.Module):
    ...
    def forward(self, x):
        ...
        # (batch_size, sequence_length, head_dim), concatenate along last dimension
...
if __name__ == "__main__":
    ...
    print("Variant A output shape:", context_vecs.shape)
    ...
    print("Variant B output shape:", context_vecs.shape)